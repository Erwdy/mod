...
public class NotDemon extends CustomCard {
    public static final String ID = ModHelper.makePath("NotDemon");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new Strup1(p, this.magicNumber), this.magicNumber));
